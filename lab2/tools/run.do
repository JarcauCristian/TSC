...
# eval vsim -novopt -quiet -coverage +code=bcesft +notimingchecks +nowarnTSCALE  -GWR_NR=$1 -GRD_NR=$2 -GWRITE_ORDER=$3 -GREAD_ORDER=$4 -GTEST_NAME=$5 -GSEED_VAL=$6 -sva top 
